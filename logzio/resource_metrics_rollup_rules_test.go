		...
		Steps: []resource.TestStep{
			{
				...
				ExpectError: regexp.MustCompile("labels must not be empty"),
			},
		},
	})
}
		...
		Steps: []resource.TestStep{
			{
				...
				ExpectError: regexp.MustCompile("for COUNTER metrics, rollupFunction must be SUM"),
			},
		},
	})
}
		...
		Steps: []resource.TestStep{
			{
				...
				ExpectError: regexp.MustCompile("rollupFunction must be set for COUNTER metrics"),
			},
		},
	})
}
