...
**Note:** The above attributes displayed only from v1.18.0. If you're using an earlier version, please upgrade and use `terraform apply -refersh` to add those attributes to your existing resources.
