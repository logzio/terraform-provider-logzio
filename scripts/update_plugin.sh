...
wget ${DOWNLOAD_URL}/providers.json -O ~/.terraform.d/metadata-repo/terraform/model/providers.json
wget ${DOWNLOAD_URL}/logzio.json -O ~/.terraform.d/metadata-repo/terraform/model/providers/logzio.json